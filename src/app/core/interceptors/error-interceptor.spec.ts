...
describe('ErrorInterceptor', () => {
  ...
  xit('should handle status code 401', () => {
    spyOn(router, 'navigateByUrl');
    spyOn(toast, 'error');
  ...
  xit('should handle status code 403', () => {
    assertStatus(403, 'Forbidden');
  });

  xit('should handle status code 404', () => {
    assertStatus(404, 'Not Found');
  });

  xit('should handle status code 500', () => {
    assertStatus(500, 'Internal Server Error');
  });

  xit('should handle others status code', () => {
    spyOn(toast, 'error');
